...
namespace OEE
{
    public partial class ucBaoCaoTongHopHieuXuat : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void Loadgrdata()
        {
            ...
            try
            {
                foreach (GridColumn gridColumn in grvTongHopHieuXuat.Columns)
                {
...
Convert.ToDecimal(grvTongHopHieuXuat.Columns["NPH"].SummaryItem.SummaryValue)) * 100), 2);
                ...
                grvTongHopHieuXuat.Columns["DMOEE"].Summary.Add(DevExpress.Data.SummaryItemType.Sum, "DMOEE", "" + dt.Rows[0]["OEE"] + "%");
                grvTongHopHieuXuat.Columns["DMPE"].Summary.Add(DevExpress.Data.SummaryItemType.Sum, "DMOEE", "" + dt.Rows[0]["PE"] + "%");
                grvTongHopHieuXuat.Columns["DMEL"].Summary.Add(DevExpress.Data.SummaryItemType.Sum, "DMOEE", "" + dt.Rows[0]["EL"] + "%");
                grvTongHopHieuXuat.Columns["SpeedVar"].Summary.Add(DevExpress.Data.SummaryItemType.Sum, "DMOEE", "" + dt.Rows[0]["SpeedVar"] + "%");
