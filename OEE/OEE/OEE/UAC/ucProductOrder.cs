...
namespace OEE
{
    public partial class ucProductOrder : DevExpress.XtraEditors.XtraForm
    {
        Int64 ithem = 0;
        ...
        #region eventForm
        private void ucItemMay_Load(object sender, EventArgs e)
        {
        ...
        private void btnGhi_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    Commons.Modules.ObjSystems.XoaTable(sBTDetail);
        ...
        private void AddbtProSchedule()
        {
            ...
            //tmp.Columns["SoCaSX"].DataType = System.Type.GetType("System.Decimal");
            try
            {
                ...
                else
                {
                    ...
                    tbProSchedule.Merge(tmp, true, MissingSchemaAction.Ignore);
                }
            }
            catch (Exception ex)
            {
