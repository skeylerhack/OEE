...
namespace OEE
{
    public partial class ucDMTBi : UserControl
    {
        ...
        private void BtnNoilapdat_Click(object sender, EventArgs e)
        {
            if (txtMS_MAY.Text == "")
            {
                XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "MsgQuyenKT6", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        ...
        public void ShowMAY(DataRow row)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(row["TEN_HSX"].ToString()))
                    ...
                    CboMS_HSX.Text = row["TEN_HSX"].ToString();
                ...
                if (string.IsNullOrEmpty(row["TEN_CONG_TY"].ToString()))
                    ...
                    cboMS_NCC.Text = row["TEN_CONG_TY"].ToString();
                ...
                if (row["TEN_DVT_RT"].ToString() == "")
                    ...
                    cboMS_DVT_RT.Text = row["TEN_DVT_RT"].ToString();
                ...
                cboMUC_UU_TIEN.Text = row["TEN_UU_TIEN"].ToString();
                ...
                try
                {
                    ...
                    if (j > 0)
                        txtSO_NAM_SD.Text = k + " " + Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "Nam_sd", Commons.Modules.TypeLanguage) + " " + j + " " + Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "Thang_sd", Commons.Modules.TypeLanguage);
                    else
                        txtSO_NAM_SD.Text = k + " " + Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "Nam_sd", Commons.Modules.TypeLanguage);
                }
                catch
                {
        ...
        private void BtnGhi_Click(object sender, EventArgs e)
        {
            ...
            {
                XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "MsgQuyenGhi1", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                txtMS_MAY.Focus();
                return;
            }
            if (MS_MAY != txtMS_MAY.Text)
            {
                ...
                {
                    XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "MsgQuyenKT20", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    txtMS_MAY.Focus();
                    return;
                }
            }
            ...
            {
                XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "msgChuaNhapTenMay", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                txtTEN_MAY.Focus();
                return;
            }
            ...
            {
                XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "MsgQuyenGhi2", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                cboMS_LOAI_MAY.Focus();
                return;
            }
            if (cboMS_NHOM_MAY.EditValue == null/* TODO Change to default(_) if this is not a reference type */ )
            {
                XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "MsgQuyenGhi3", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                cboMS_NHOM_MAY.Focus();
                return;
            }
            if (txtNGAY_DUA_VAO_SD.Text == "")
            {
                XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "MsgQuyenGhi4", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                txtNGAY_DUA_VAO_SD.Focus();
                return;
            }
            if (cboMS_HIEN_TRANG.EditValue == null/* TODO Change to default(_) if this is not a reference type */ )
            {
                XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "MsgQuyenGhi5", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            ...
            {
                XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "MsgQuyenGhi6", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            ...
            {
                XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "ChuaNhapHeThong", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            ...
            {
                XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "msgChuaNhapDonViThoiGian", Commons.Modules.TypeLanguage) + " runtime", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                cboMS_DVT_RT.Focus();
                return;
            }
            ...
            {
                XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "msgChuaNhapDonViThoiGian", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            ...
            if (TxtMS_NHA_XUONG.Text == "")
            {
                XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "MsgQuyenGhi7", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            ...
            {
                XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "MsgQuyenGhi8", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            ...
            try
            {
                ...
                XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(this.Name, "msgGhiThanhCong"));
                if (MS_MAY == "-1")
                {
        ...
        private void BtnXoa_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (txtMS_MAY.Text == "")
                {
                    XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "MsgQuyenXoa1", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    return;
                }
                ...
                while (dtReader.Read())
                {
                    XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "MsgQuyenXoa35", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    dtReader.Close();
                    return;
                }
                dtReader.Close();
                ...
                while (dtReader.Read())
                {
                    XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "MsgQuyenXoa3", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    dtReader.Close();
                    return;
                }
                dtReader.Close();
                ...
                while (dtReader.Read())
                {
                    ...
                    XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "MsgQuyenXoa4", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    dtReader.Close();
                    return;
                }
                dtReader.Close();
                ...
                while (dtReader.Read())
                {
                    ...
                    XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "MsgQuyenXoa23", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    dtReader.Close();
                    return;
                }
                dtReader.Close();
                ...
                while (dtReader.Read())
                {
                    ...
                    XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "MsgQuyenXoa24", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    dtReader.Close();
                    return;
                }
                dtReader.Close();
                ...
                while (dtReader.Read())
                {
                    XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "MsgQuyenXoa26", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                ...
                while (dtReader.Read())
                {
                    XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "MsgQuyenXoa29", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                ...
                while (dtReader.Read())
                {
                    XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "MsgQuyenXoa30", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                ...
                while (dtReader.Read())
                {
                    XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "MsgQuyenXoa31", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                ...
                while (dtReader.Read())
                {
                    XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "MsgQuyenXoa45", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                ...
                while (dtReader.Read())
                {
                    XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "MsgQuyenXoa47", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                ...
                while (dtReader.Read())
                {
                    XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "MsgQuyenXoa047", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                ...
                traloi = XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "MsgQuyenXoa5", Commons.Modules.TypeLanguage), this.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                ...
                SqlHelper.ExecuteNonQuery(Commons.IConnections.CNStr, CommandType.Text, SQL);
                SqlHelper.ExecuteNonQuery(Commons.IConnections.CNStr, "UpdateMAY_LOG", txtMS_MAY.Text, this.Name, Commons.Modules.UserName, 3);
