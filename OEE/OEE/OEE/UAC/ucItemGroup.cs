...
namespace OEE
{
    public partial class ucItemGroup : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void ucItemGroup_Load(object sender, EventArgs e)
        {
            try
            {
                LoadData(-1);
        ...
        void composLink_CreateMarginalHeaderArea(object sender, CreateAreaEventArgs e)
        {
            ...
            e.Graph.DrawString(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "ucItemGroup", "bcTieuDeucItemGroup", Commons.Modules.TypeLanguage), Color.Black, rec, BorderSide.None);
