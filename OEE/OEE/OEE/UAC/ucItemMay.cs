...
namespace OEE
{
    public partial class ucItemMay : DevExpress.XtraEditors.XtraForm
    {
        Int64 ithem = 0;
        ...
        private void DeleteDatadetails()
        {
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(Commons.IConnections.CNStr, CommandType.Text, "DELETE dbo.ItemMay WHERE MS_MAY ='" + (grvItemMay.GetFocusedRowCellValue("MS_MAY") + "' AND ItemID = "+(grvItem.GetFocusedRowCellValue("ID"))+" "));
