...
--SELECT * FROM dbo.[MGetApiOEE1](-1,-1,'-1','2020-03-02 14:00:00.000','2022-03-02 14:00:00.000','admin',0)
ALTER FUNCTION [dbo].[MGetApiOEE1]
(
	@CAID INT =3,
	@ID_TO BIGINT = -1,
...
( SELECT T.OperatorID,T.ItemID,T.MS_MAY,T.StartTime,StandardOutput,T.CaSTT,T.ActualQuantity,
        ...
        FROM    (
SELECT  A.OperatorID,A.MS_MAY,A.StartTime,A.ActualQuantity,A.StandardOutput,A.ItemID,B.CaSTT, [dbo].[fnGetQuantityCapacity](ItemID,
